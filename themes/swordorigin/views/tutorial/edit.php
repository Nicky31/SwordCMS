...
<tr> 
  ...
  <td align="center"><input type="text" name="title" id="titre" value="<?php echo htmlspecialchars($titre); ?>" style="width:480px;"/></td>
</tr>

<tr>
  <td align="center">Tutoriel :</td>
  <td align="center"><textarea name="content" cols="70" style="width:480px;" rows="14"><?php echo htmlspecialchars($text); ?></textarea></td>
</tr> <br />
